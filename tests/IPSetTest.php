		...
		$testcases = array(
			'old_list_subset' => array(
				...
				array(
					...
					'10.64.0.122' => false,
					'10.64.0.123' => '10.64.0.123',
					'10.64.0.124' => '10.64.0.124',
					'10.64.0.129' => '10.64.0.129',
					'10.64.0.130' => false,
					'91.198.174.81' => '91.198.174.81',
					'91.198.174.80' => false,
					'0::0' => false,
					'ffff:ffff:ffff:ffff:FFFF:FFFF:FFFF:FFFF' => false,
					'2001:db8::1234' => false,
					'2620:0:862:1:26b6:fdff:fef5:abb3' => false,
					'2620:0:862:1:26b6:fdff:fef5:abb4' => '2620:0:862:1:26B6:FDFF:FEF5:ABB4',
			...
			'new_cidr_set' => array(
				...
				array(
					...
					'10.128.0.0' => '10.128.0.0/24',
					'10.64.17.55' => '10.64.16.0/22',
					'10.64.20.0' => false,
					'10.64.27.207' => false,
					'10.64.31.255' => false,
					'0::0' => false,
					...
					'2620:0:862:102:10:20:0:113' => '2620:0:862:102::/64',
				),
			),
			'empty_set' => array(
				array(),
			...
			'edge_cases' => array(
				...
				array(
					...
					'2620:0:862:102:10:20:0:113' => false,
					'10.10.9.255' => false,
					'10.10.10.0' => '10.10.10.10/25',
					'10.10.10.1' => '10.10.10.10/25',
					'10.10.10.10' => '10.10.10.10/25',
					'10.10.10.126' => '10.10.10.10/25',
					'10.10.10.127' => '10.10.10.10/25',
					'10.10.10.128' => false,
					'10.10.10.177' => false,
					'10.10.10.255' => false,
					'10.10.11.0' => false,
			...
			'exercise_optimizer' => array(
				...
				array(
					...
					'ffff:ffff:ffff:ffff:ffff:ffff:ffa0:0' => 'ffff:ffff:ffff:ffff:ffff:ffff:ffa0:0/107',
					'ffff:ffff:ffff:ffff:ffff:ffff:ffc0:1234' => 'ffff:ffff:ffff:ffff:ffff:ffff:ffc0:0/107',
					'ffff:ffff:ffff:ffff:ffff:ffff:ffed:ffff' => 'ffff:ffff:ffff:ffff:ffff:ffff:ffec:0/111',
					'ffff:ffff:ffff:ffff:ffff:ffff:fff4:4444' => 'ffff:ffff:ffff:ffff:ffff:ffff:fff4:0/112',
					'ffff:ffff:ffff:ffff:ffff:ffff:fff9:8080' => 'ffff:ffff:ffff:ffff:ffff:ffff:fff9:8000/113',
					'ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff' => 'ffff:ffff:ffff:ffff:ffff:ffff:ffff:0/112',
					'ffff:ffff:ffff:ffff:ffff:ffff:fe00:0' => 'ffff:ffff:ffff:ffff:ffff:ffff:fe00:0/111',
					'ffff:ffff:ffff:ffff:ffff:ffff:fe01:0' => 'ffff:ffff:ffff:ffff:ffff:ffff:fe00:0/111',
			...
			'overlap' => array(
				...
				array(
					'0.0.0.0' => false,
					'10.10.10.0' => '10.10.10.0/25',
					'10.10.10.1' => '10.10.10.0/25',
					'255.255.255.255' => false,
				),
			),
		);
